    ...
    <div className="px-4 pb-2 shrink-0 border-t border-gray-200 dark:border-border pt-3">
      <div className="flex gap-2">
        ...
        <Button
          ...
          className="flex-1 px-4 py-2 text-sm font-medium rounded-xl bg-gray-100 dark:bg-muted text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-muted/80 transition-colors"
        >
          Start New
        </Button>
      </div>
