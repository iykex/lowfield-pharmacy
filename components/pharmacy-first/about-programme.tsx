      ...
      <WidthConstraint className="space-y-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-2">
          ...
          <p className="text-gray-600 dark:text-white/60 leading-9 z-10">
            ...
            strain on GP services. At Lowfield Pharmacy, we are committed to
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {PFP_BENEFITS.map((benefit, index) => {
            ...
            return (
              ...
              >
                <div className="mb-4 flex size-12 items-center justify-center rounded-full bg-card group-hover:bg-ring transition-colors duration-300">
