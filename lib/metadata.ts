...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://lowfieldpharmacy.net";
const SITE_NAME = "Lowfield Pharmacy";

export const rootMetadata: Metadata = {
  title: SITE_NAME,
  description:
    "Your trusted community pharmacy providing NHS services, prescriptions, health consultations, and personalized care in South Croydon, London.",
  keywords: [
    "Pharmacy",
    "Drug Store",
    "Medicine",
